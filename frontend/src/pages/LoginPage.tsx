  ...
  return (
    <div className="min-h-[calc(100vh-80px)] bg-gray-50 flex items-center justify-center p-4 sm:p-6 lg:p-12">
      <div className="w-full max-w-5xl bg-white rounded-3xl border border-gray-200 overflow-hidden shadow-xl grid grid-cols-1 lg:grid-cols-12">
        ...
        <div className="lg:col-span-7 p-6 sm:p-10 space-y-6">
          <div>
            <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-violet-100 text-violet-700 border border-violet-200 text-xs font-semibold mb-3">
              <Sparkles className="w-3.5 h-3.5 text-violet-600" /> Citizen Portal Sign In
            </div>
            <h1 className="text-2xl sm:text-3xl font-display font-black text-gray-900">Welcome back</h1>
            <p className="text-gray-500 text-sm mt-1">Sign in to review your saved schemes and eligibility updates.</p>
          </div>
          ...
          <div className="relative flex items-center justify-center">
            ...
            <span className="bg-white px-3 text-xs text-gray-400 uppercase tracking-wider">or sign in with credentials</span>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <p className="text-center text-gray-500 text-xs pt-2">
              ...
              <Link to="/register" className="text-violet-600 hover:text-violet-700 font-bold underline">
        ...
        <div className="hidden lg:flex lg:col-span-5 bg-gradient-to-br from-purple-600 via-indigo-600 to-violet-600 text-white p-10 flex-col justify-between relative overflow-hidden">
          <div>
